...
class Activity {
	constructor(id, actionId, actionName, startAt, endAt, expTime, expActionId, expActionName, roles, roleNames){
		this.id = id;
...
function criarActivity(){
	...
	activity = new Activity(activities.length, actionId, actionName, startAt, endAt, expTime, expActionId, expActionName, roles, roleNames);
...
function addActRow(tableID) {
	...
	newCell.appendChild(newText);
	newCell.innerHTML = activity.roleNames;
